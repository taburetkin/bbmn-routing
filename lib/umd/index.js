(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore'), require('bbmn-utils'), require('bbmn-core'), require('jquery'), require('bbmn-components'), require('bbmn-mixins')) :
	typeof define === 'function' && define.amd ? define(['exports', 'underscore', 'bbmn-utils', 'bbmn-core', 'jquery', 'bbmn-components', 'bbmn-mixins'], factory) :
	(factory((global.bbmn = global.bbmn || {}, global.bbmn.routing = {}),global._,global.bbmnUtils,global.bbmnCore,global.$,global.bbmnComponents,global.bbmnMixins));
}(this, (function (exports,_,bbmnUtils,bbmnCore,$,bbmnComponents,bbmnMixins) { 'use strict';
...
var historyApi = {
	...
	loadUrl: function loadUrl(fragment) {
		...
		fragment = bbmnCore.history.fragment = bbmnCore.history.getFragment(fragment);
...
var PageRouter = Router$1.extend({
	...
	startPage: function startPage(page) {
		...
		return this.beforePageStart(page).then(function () {
			...
			return _this2.afterPageStart.apply(_this2, [page].concat(_toConsumableArray(args)));
		});
	},
...
var Page = BasePage.extend({
	...
	getPathHash: function getPathHash() {
		var self = this.getHash();
		var path = [self];
		var parent = this.getParent();
		if (parent && _.isFunction(parent.getPathHash)) {
			path.unshift.apply(path, _toConsumableArray$1(parent.getPathHash()));
		}
		return path;
	},
	...
	getView: function getView(opts) {
		var options = _.extend({ model: this.model, collection: this.collection }, opts);
