...
import { betterResult, comparator, getOption, isKnownCtor, mergeOptions, mix, paramsToObject } from 'bbmn-utils';
import { MnObject, Router, history } from 'bbmn-core';
import $ from 'jquery';
...
var PagedApp = App.extend({
	...
	_startHistory: function _startHistory() {
		var historyOptions = this.getOption('startHistory');
		if (!historyOptions) {
			return;
		}
